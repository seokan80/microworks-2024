		...
		<div id="headerInnerWrap">
			...
			<div id="headerInner" class="clearfix">
				...
				<div class="header-util-box">
					...
					<div class="header-lang">
						<a href="javascript:;" class="lang-open-btn"><i class="material-icons">&#xe80b;</i><strong>CHINESE</strong></a>
						<ul>
							<li class="item01"><a href="<?=$site_host?>/en/">ENGLISH</a></li>
							<li class="item02"><a href="<?=$site_host?>/kr/">KOREAN</a></li>
						</ul>
					</div>
					<!-- 사이트맵 버튼 ( 기본 라인 三 ) -->
			...
			<nav id="gnb" class="each-menu">
				...
				<ul class="clearfix menu5 area">
					<li class="gnb1">
						<a href="<?=$site_url?>/company/summary.php">公司</a>
						<div class="gnb-2dep">
							<ul>
					...
					<li class="gnb2">
						<a href="<?=$site_url?>/do/memory.php">服务项目</a>
						<div class="gnb-2dep">
							<ul>
					...
					<li class="gnb3">
						<a href="<?=$site_url?>/product/trend_list.php"> 产品搜索 </a>
						<div class="gnb-2dep">
							<ul>
					...
					<li class="gnb4">
						<a href="<?=$site_url?>/industrial/transcend.php">特许经营店</a>
						<div class="gnb-2dep">
							<ul>
					...
					<li class="gnb5">
						<a href="<?=$site_url?>/company/notice.php">联系方式</a>
						<div class="gnb-2dep">
							<ul>
