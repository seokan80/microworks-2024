			...
			<article id="mainInquiryCon" class="scroll-animate">
					<div class="area02 fade-in-down fade-in-03">
						<form action="/contact/inquiry_ok.php" name="form" method="post" enctype="multipart/form-data">
							<h5 class="text-white">询价</h5>
							<div class="main-inquiry">
								<div class="inquiry-wrapper">
									<div class="forms required">
										<i class="material-icons">&#xe8a6;</i>
										<label for="user-name">名</label>
										<input type="text" id="user-name" placeholder="请输入名字。" name="user-name" required="required">
									</div>
									<div class="forms required">
										<i class="material-icons">&#xe0e1;</i>
									...
									<div class="forms required">
										<i class="material-icons">&#xe551;</i>
										<label for="user-contact">手机号码</label>
										<input type="text" id="user-contact" placeholder="ex)010-1234-5678" name="user-contact"
											required="required">
									</div>
									<div class="forms">
										<i class="material-icons">&#xe8f8;</i>
										<label for="user-company">公司名称</label>
										<input type="text" id="user-company" placeholder="请输入公司名。" name="user-company">
									</div>
								...
								<div class="agreement-wrapper">
									<div class="split-container align-center">
										<span class="ox">
											...
											<label for="agree1"><i class="material-icons">&#xe876;</i>我接受隐私政策。</label>
										</span>
										<a href="javascript:;" onclick="javascript:layerLoad('/service/privacy.php'); return false;"
											class="button type-line size-sm"><strong>隐私政策</strong></a>
									</div>
									<div class="text-area">
										<textarea name="content" class="main-textarea"></textarea>
										<p class="main-textarea-txt"><i class="material-icons">&#xe0b7</i><strong>内容</strong> <span>(请输入少于100个字符。)</span></p>
									</div>
									<dl class="contact">
										<dt>* CONTACT:</dt>
									...
									<a href="javascript:;" onClick="sendit();"
										class="button size-xl type-line fluid main-form-btn">已完成</a>
								</div>
							</div>
						</form>
