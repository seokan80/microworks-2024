...
<!--							<p class="global-tit"><b>汇率</b><span>Exchange Rate (--><?php //=date("Y")?><!--/--><?php //=date("m")?><!--/--><?php //=date("d")?><!-- data)</span></p>-->
...
<!---->
<!--									<tr>-->
<!--										<th><p><span class="plag-icon"><img src="--><?php //=$site_host?><!--/images/main/main_exchange_usd_icon.jpg" alt=""></span>美国 (USD)</p></th>-->
<!--										<td>--><?php //=$op1?><!--</td>-->
...
<!---->
<!--									<tr class="blue-row">-->
<!--										<th><p><span class="plag-icon"><img src="--><?php //=$site_host?><!--/images/main/main_exchange_jpy_icon.jpg" alt=""></span>日本 (JPY)</p></th>-->
<!--										<td>--><?php //=$op1?><!--</td>-->
<!--										<td><p class="net-change"><span class="--><?// if($_scp>0){ ?><!--up-icon--><?// } else if($_scp<0){ ?><!--down-icon--><?// } ?><!--"></span>--><?php //=$_scp?><!--</p></td>-->
<!--										<td><p class="up-down"><span class="--><?// if($_scp>0){ ?><!--up-icon--><?// } else if($_scp<0){ ?><!--down-icon--><?// } ?><!--"></span> --><?// if($_scp>0){ ?><!--+--><?// } else if($_scp<0){ ?><!-----><?// } ?><!----><?php //=sprintf('%0.2f',$_openusd_op)?><!--%</p></td>-->
<!--									</tr>-->
...
<!---->
<!--									<tr>-->
<!--										<th><p><span class="plag-icon"><img src="--><?php //=$site_host?><!--/images/main/main_exchange_eur_icon.jpg" alt=""></span>欧洲联盟 (EUR)</p></th>-->
<!--										<td>--><?php //=$op1?><!--</td>-->
<!--										<td><p class="net-change"><span class="--><?// if($_scp>0){ ?><!--up-icon--><?// } else if($_scp<0){ ?><!--down-icon--><?// } ?><!--"></span>--><?php //=$_scp?><!--</p></td>-->
<!--										<td><p class="up-down"><span class="--><?// if($_scp>0){ ?><!--up-icon--><?// } else if($_scp<0){ ?><!--down-icon--><?// } ?><!--"></span> --><?// if($_scp>0){ ?><!--+--><?// } else if($_scp<0){ ?><!-----><?// } ?><!----><?php //=sprintf('%0.2f',$_openusd_op)?><!--%</p></td>-->
<!--									</tr>-->
...
<!---->
<!--									<tr class="blue-row">-->
<!--										<th><p><span class="plag-icon"><img src="--><?php //=$site_host?><!--/images/main/main_exchange_cny_icon.jpg" alt=""></span>中国 (CNY)</p></th>-->
<!--										<td>--><?php //=$op1?><!--</td>-->
<!--										<td><p class="net-change"><span class="--><?// if($_scp>0){ ?><!--up-icon--><?// } else if($_scp<0){ ?><!--down-icon--><?// } ?><!--"></span>--><?php //=$_scp?><!--</p></td>-->
<!--										<td><p class="up-down"><span class="--><?// if($_scp>0){ ?><!--up-icon--><?// } else if($_scp<0){ ?><!--down-icon--><?// } ?><!--"></span> --><?// if($_scp>0){ ?><!--+--><?// } else if($_scp<0){ ?><!-----><?// } ?><!----><?php //=sprintf('%0.2f',$_openusd_op)?><!--%</p></td>-->
<!--									</tr>-->
