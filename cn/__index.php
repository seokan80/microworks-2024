				...
				<div class="main-visual-item  "><!-- 디폴트 이미지-->
					...
					<div class="main-visual-txt-con">
						<div class="main-visual-txt-inner area-box">
							...
							<p class="main-visual-txt2">Semiconductor Total Solution</p>
							...
							<div class="main-visual-video-btn"><a href="javascript:;" onclick="javascript:layerLoad('<?=$site_url?>/index_video_popup.php'); return false;" class=""><i class="material-icons">&#xe62e</i>Microworks 媒体</a></div>
						</div>
					</div>
				</div>
					...
					<div class="visual-side-item item02" data-slide="2">
						<a href="<?=$site_url?>/do/line.php">
							<div class="inner">
								...
								<p class="side-item-txt"><span><em>代理</em></span></p>
							</div>
						</a>
					</div>
					...
					<div class="main-search-box">
						<div class="main-search-select" >
							...
							<ul class="main-select-con">
								<li><a href="javascript:search_sel(1);"><span>Memory 趋势</span></a></li>
								<li><a href="javascript:search_sel(2);"><span>现货清单</span></a></li>
				...
				<div class="area02">
					<div class="inner clearfix">
						<div class="about-con">
							...
							<a href="<?=$site_url?>/company/summary.php" class="detail-btn fade-in-down fade-in-07"><span>Detail View</span></a>
						</div>
				...
				<div class="area02">
					<form action="<?=$site_url?>/contact/inquiry_ok.php" name="form" method="post" enctype="multipart/form-data">
						<div class="main-inquiry-con clearfix fade-in-down fade-in-03">
							<div class="left-con">
								<p class="inquiry-tit">询价</p>
								<ul class="main-inquiry-list">
									<li>
										<p class="inquiry-info clearfix">
											<span class="info-tit"><i class="material-icons">&#xe8a6</i>名</span>
											<em><input type="text" placeholder="请输入名字。" name="name"></em>
										</p>
									</li>
									<li>
										<p class="inquiry-info clearfix">
											<span class="info-tit"><i class="material-icons">&#xe0e1</i>电子邮件</span>
											<em><input type="text" placeholder="ex)admin@microworks.com" name="email"></em>
										</p>
									</li>
									<li>
										<p class="inquiry-info clearfix">
											<span class="info-tit"><i class="material-icons">&#xe551</i>手机号码</span>
											<em><input type="text" placeholder="ex)010-1234-5678" name="phone"></em>
										</p>
									</li>
									<li>
										<p class="inquiry-info clearfix">
											<span class="info-tit"><i class="material-icons">&#xe8f8</i>公司名称</span>
											<em><input type="text" placeholder="请输入公司名。" name="company"></em>
										</p>
									</li>
								</ul>
							</div>
							<div class="right-con">
								<div class="agreement-tit-box">
									<input type="checkbox" id="agree1"><label for="agree1"><span class="agreement-tit"><i class="material-icons">&#xe876</i>我接受隐私政策。</span></label>
									<a href="javascript:;" onclick="javascript:layerLoad('<?=$site_url?>/service/privacy.php'); return false;" class="agreement-link"><span>隐私政策</span></a>
								</div>
								<div class="text-area">
									<p class="main-textarea-txt"><i class="material-icons">&#xe0b7</i>内容	 <span>(请输入少于100个字符。)</span></p>
									<textarea name="content" class="main-textarea"></textarea>
								</div>
								<a href="javascript:;"  onClick="sendit();" class="main-form-btn"><span>已完成</span></a>
							</div>
						</div>
					</form>
