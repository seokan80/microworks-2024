...
$bbs_row = $db->object("cs_bbs_data","where code='stock' and lang='2' order by ref desc, idx desc limit 1");

$rs = $db->select("cs_bbs_data","where code='stock' and lang='2' order by idx asc");
$qb = "";
...
if($qb){
	$query=" where ($qb) and kind='1' ";
} else {
	$query=" where ex_code='$bbs_row->ex_code' and kind='1' ";
}
if($search_order){
...
<? include $_SERVER["DOCUMENT_ROOT"].$site_directory."/include/top.php"; ?>
				...
				<article class="sub-page product-page">
					...
					<article class="product-tit-box">
						<p class="product-tit">자사가 보유중인 재고로, 체크박스로 하단의 카트에 담은 후 문의바랍니다.</p>
					</article>
					<!-- 
					...
					<article class="bbs-list-con product-board-con product-list-con">
						<div class="top-con-inner clearfix">
							<div class="tel-info-box">
								<ul class="clearfix">
									<li class="tel01"><a href="tel:02-6112-7327"><span><em><i class="material-icons">&#xe862</i>재고문의 : 02-6112-7328</em></span></a></li>
									<li class="tel02"><a href="tel:02-6112-7320"><span><em><i class="material-icons">&#xe0b0</i>대표전화 : 02-6112-7320</em></span></a></li>
								</ul>
							</div>
							<form action="<?=$_SERVER[PHP_SELF]?>" method="get">
								<div class="board-search-box">
									<input placeholder="부품명을 입력하세요." type="search" name="search_order" class="search-word" value="<?=$search_order?>">
