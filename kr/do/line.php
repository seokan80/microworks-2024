...
<? include $_SERVER["DOCUMENT_ROOT"].$site_directory."/include/top.php"; ?>
				<!-- 컨텐츠 내용 -->
				<article class="do-page line-page area">
					<article class="line-tit-box">
						<p class="line-tit">마이크로웍스 코리아㈜와 <b>함께하고있는 파트너, 라인카드입니다.</b></p>
						<p class="line-tit-txt">서로 믿고 신뢰할 수 있는 관계를 만드는 것은 언제나 환영합니다.</p>
					</article>
					<article class="line-con">
						<p class="line-con-tit"><span>F</span>ranchise Distributor Line</p>
					...
					<article class="line-con">
						<p class="line-con-tit"><span>M</span>ixed Singal, Analog</p>
						<div class="parti-list">
							<ul class="clearfix">
								<!-- 권장사이즈 165x30 -->
					...
					<article class="line-con">
						<p class="line-con-tit"><span>F</span>PGA</p>
						<div class="parti-list">
							<ul class="clearfix">
								<!-- 권장사이즈 165x30 -->
					...
					<article class="line-con">
						<p class="line-con-tit"><span>R</span>elay</p>
						<div class="parti-list">
							<ul class="clearfix">
								<!-- 권장사이즈 165x30 -->
					...
					<article class="line-con">
						<p class="line-con-tit"><span>M</span>emory</p>
						<div class="parti-list">
							<ul class="clearfix">
								<!-- 권장사이즈 165x30 -->
					...
					<article class="line-con">
						<p class="line-con-tit"><span>M</span>CU & CPU</p>
						<div class="parti-list">
							<ul class="clearfix">
								<!-- 권장사이즈 165x30 -->
					...
					<article class="line-con">
						<p class="line-con-tit"><span>C</span>onnector</p>
						<div class="parti-list">
							<ul class="clearfix">
								<!-- 권장사이즈 165x30 -->
				...
				<p style="font-size:1px; color:#fff">
ST STM Cavium Omnivision Micron mup connector 불용재고 EOL 단종 China connector DDR Sdram Nand Nor MCU CPU Image Sensor 구매대행 Turn key
Sourcing CORERISE/SSD GOODRAM/MEMORY CARD 연구개발샘플 해외구매대행 M25P- MT- S34ML- TMS320 series FM- CY7C1312KV18-250BZXC KPT-     RC-     U6254M41-JBL-GR TLV320AIC3204IRHBR XC9572XL-10VQG64C EMMC16G EMMC08G MT47H32M16NF-25E:H FM24CL64B-GATR Micron Cypress Spansion TI Xilinx Kingston Kingbright Intel CPU Macronix F-RAM DDR NAND NOR FLASH Serial FLASH 쿠첸 대리점 구매대행 EMMC 메모리 동향 현대모비스 의료기   C 산출 HOT OFFER 특가 MOUSER DIGI-KEY Element14 샘플 AP1510SG-13 AP1501A-50K5G-13 AZ1117CH-3.3TRG1 AZ1117CH-ADJTRG1 WM8758CBGEFL/RV SII164CTG64 BZT52C5V6S-7-F CS4344-CZZR CS42L52-CNZR RT9818C-29GV RT8064ZQW B560C-13-F 1N4003-T SIL3132CNU MP1488DJ-LF-Z MP1583DN-LF-Z MP1528DK-LF-Z SE2435L-R NT5CB128M16IP-FL NT5TU128M8HE-ACI 다이오즈 페리콤 엠피에스 비쉐이 씨러스로직 울프슨 레티  세미컨덕터 실리콘이미지 난야 로옴 실리콘래버토리스 액티브세미 에이케이엠 갤럭시 셈텍 제넘 마이크로세미 페러그린 리치텍 스카이웍스 트랜센드SD Diodes Pericom MPS Vishay CirrusLogic Wolfson Lattice Silicon Image Nanya Rohm silicon Labs Active-Semi AKM Galaxy Gennum Semtech Microsemi Peregrine SKYworks Richtek Transcend SD 전자부품 당일배송 유통회사 LED발광 전원관리모듈 온도센서 습도센서 통신모듈 릴레이 콘덴서 스위칭전압조정기 적외선데이터통신 오디오센서 MCU CAVIUM 메모리OFFER LOGIC ANALOG SSD PASSIVE CONECTOR CAPACITER EOL TFT LCD SAMPLE KIT buzzer AUTOMOTIVE RELAYS SMD INDUCTORS MICROSEMI MODULE OBSOLETE CRYSTAL OSCILLATORS CONNECTOR MEMORY DIODES TRANSISTORS DISTRIBUTOR EMMC SHORTAGES DISCONTINUED   RT LED AUTHORIZED DISTRIBUTOR PASSIVE ACTIVE COMPONETS SMD FUSE DATA SHEET PB FREE NEW ORIGINAL 크리스탈 모듈 정식대리점 퓨즈 단종자재 저항 스탁자재 장납기 단납기자재 정품 해외소싱 글로벌소싱 데이터시트 이미지센서 먼지센서 오토모티브 인더스트리얼 당일선적 수동소자 능동소자 블루투스모듈 바리스타 칩안     드 누보톤 인터실 인피니온 기가디바이스 텔레칩스 리얼텍 에스티 넥스피리아 ESMT EON  12PIN 24PIN 24V 16MB 5A 4.5V 28PIN 2A 0.5A 16G 32G 128G 64MB 32MB 128MB EN25Q W25Q MAX STM32F RT9 KLM SN7 LM2 TLP MC3 TMS SOT23 QFN24 TR SOP8 DIP TSSOP20 TO263 QFP-64 WSON8 BGA TO263 MSOP10 반도    해외쏘싱 Global sourcing 한국대리점 제미츠대리점 긴급자재 스탁쏘싱 Stock sourcing NAND DRAM NOR ERAI 메모리동향 단납기자재 특가견적 단종자재 EOL자재 메모    IC샘플 Onsemi Winbond GigaDevice AVX ISSI Exar Molex 히로세 텔레칩스 웨스턴디지털 시게이트 옴니비전 삼성 자이언텍 Hirose Telechips MUP HYE Witmag Omnivision ISSI Samsung Giantec Connector 커넥터 Automotive    티브 RJ45Jack AVN POS HDD 하드디스크드라이브 긴급스탁 반도체무역 LCD 불용재고매입 PCB 납기지연 Crystal 크리스탈 LED Image Sensor 이미지센서 Evaluationboard 개발보드 turn-key 턴키 턴키공급 Powercode AD analog device adata Altera AMD AOS API Delevan Atmel Audiocodes avago bluekey bosch broadcom BSI cavium cilicoils cirrus logic cirrus commax conexant core rise csr cypress Dram duke extrusion Elpida eon epson ESMT EXAR Fairchild freescale fujitsu galaxy galaxy century genesis GenessysLogic Gennum goodram HGST Hittle HRS Hynix ICSI IDT Intel intersil ISCP ISSI ixys jmicron KC KET Kingston Kingston technology Lattice LIG LS Macronix maxim Micrel Microchip Micron Microsemi microworks MPS Mstar Mxic Nais Nanya Nanya-technology Novoton Numonyx NXP Oki Omnivision Onsemilogo Os-con Panasonic Piecemakers Pixelworks Posbank realtek Richtek Runcore Samsung sandisk Sanyo Schreiner Protech Seagate seiko Instruments seoul semiconductor sewoo sharp silicon image silicon labs silicon power simens Sk hynix Solidware sony Spansion SST ST STM Sumida techwell Teridian Texas instrument thinkprog ti toshiba Tova transcend Via Viasat Vishay Volex watkingjohnson wd winbond woifson xilinx x-power zarlink zemilitz zentel zilog dasan 아날로그 디바이스 에이데이타 에이엠디 블루키 보쉬 브로드컴 코어라이즈 디램 듀크 엡손 하이닉스 프리스케일 갤럭시 센츄리 제네시스 제네시스로직 굿램 인텔 킹스톤 마이크론 마이크로닉스 맥심 마이크로칩 마이크로웍스 오스콘 피스메이커 픽셀워크 삼성 샌디스크 산요 시게이트 파나소닉 서울반도체 샤프 소니 SK 하이닉스 솔리드웨어 볼렉스 도시바 트랜샌드 윈본드 반도체 semiconductor IC ICs module
</p>
