					...
					<div class="global-con clearfix">
						...
						<!-- !NOTE : 기존소스 참고해주세요 -->
							<div class="exchange-con fade-in-down fade-in-08">
								<p class="global-tit"><strong>Exchange Rate</strong><span>Exchange Rate (2024/03/25 기준 데이터)</span></p>
			...
			<article id="mainInquiryCon" class="scroll-animate">
					<div class="area02 fade-in-down fade-in-03">
						<form action="/contact/inquiry_ok.php" name="form" method="post" enctype="multipart/form-data">
							<h5 class="text-white">Online Inquiry</h5>
							<div class="main-inquiry">
								<div class="inquiry-wrapper">
									<div class="forms required">
										<i class="material-icons">&#xe8a6;</i>
										<label for="user-name">Name</label>
										<input type="text" id="user-name" placeholder="Please enter your name." name="user-name" required="required">
									</div>
									<div class="forms required">
										<i class="material-icons">&#xe0e1;</i>
									...
									<div class="forms required">
										<i class="material-icons">&#xe551;</i>
										<label for="user-contact">Tel</label>
									...
									<div class="forms">
										...
										<input type="text" id="user-company" placeholder="Please enter your company name." name="user-company">
									</div>
								...
								<div class="agreement-wrapper">
									<div class="split-container align-center">
										<span class="ox">
											...
											<label for="agree1"><i class="material-icons">&#xe876;</i>I agree with the privacy policy.</label>
										</span>
										<a href="javascript:;" onclick="javascript:layerLoad('/service/privacy.php'); return false;"
											class="button type-line size-sm"><strong>View Privacy Policy</strong></a>
									</div>
									<div class="text-area">
										<textarea name="content" class="main-textarea"></textarea>
										<p class="main-textarea-txt"><i class="material-icons">&#xe0b7</i><strong>Content</strong> <span>(No more than 100 characters.)</span></p>
									</div>
									<dl class="contact">
										<dt>* CONTACT:</dt>
									...
									<a href="javascript:;" onClick="sendit();"
										class="button size-xl type-line fluid main-form-btn">Submit</a>
								</div>
							</div>
						</form>
