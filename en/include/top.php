	...
	<div id="container">
		...
		<div id="middleArea">
			...
			<?if($sub_section == 'memory-biz'){?>
				<!-- !NOTE S: 2024-04 추가 -->
					<div class="tabs area">
						<a href="<?=$site_url?>/product/trend_list.php" class="tab <?if($dep3_num == '01'){?>active <?}?>">Memory Price Trends</a>
						<a href="<?=$site_url?>/product/trend_list_2.php" class="tab <?if($dep3_num == '02'){?>active <?}?>">Search for memory replacement</a>
						<a href="<?=$site_url?>/product/trend_list_3.php" class="tab <?if($dep3_num == '03'){?>active <?}?>">Memory stock inventory inquiry</a>
					</div>
					<!-- !NOTE E: 2024-04 추가 -->
			<?}?>
