				...
				<article class="sub-page product-page">
					<div class="area">
						<article class="product-tit-box">
							<p class="product-tit">We have our own stock list also can support stock sourcing if you want.</p>
						</article>
						<!-- 
						...
						<article class="bbs-list-con product-board-con product-list-con">
							...
							<div class="bbs-list-tbl">
								<p class="bbs-list-head">
									<span style="width:8%;"><em>No</em></span>
								...
								?>
								   ...
								   <?}?>
										<div class="column bbs-no-data">  <!-- 200715 :: 체크박스 추가, 클래스 추가 등 수정되었습니다. -->
