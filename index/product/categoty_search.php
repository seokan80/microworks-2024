<article class="sub-page product-page pc-only hide" id="categorySearch">
    <div class="area02">
                ...
                <div class="search-results-body">
                    ...
                    <div class="search-filters">
                        ...
                        <div class="filter">
                            ...
                            <div class="filter-body">
                                <div class="input-box"><input type="search" name="" id="" placeholder="검색 기준"
                                        class="input hight-sm"></div>
                                <ul class="checkable-items">
                                    <li class="checkable-item">
                    ...
                    <div class="replacement-table-wrap margin-top-xxl">
                        <div class="replacement-table-header">
                            ...
                            <div class="button-layout gap-md extra">
                                <button type="button" class="button type-secondary size-sm"><strong>표
                                        다운로드</strong></button>
                                <button type="button" class="button type-point size-sm"><strong>n개
                                        제품비교</strong></button>
                            </div>
                        </div>
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th>
                                            ...
                                            <div class="sort-wrap">
                                                <button type="button" class="sort-button"><i
                                                        class="material-icons">&#xe5cf;</i></button>
                                                <button type="button" class="sort-button"><i
                                                        class="material-icons">&#xe316;</i></button>
                                            </div>
                                        ...
                                        <td class="text-left">
                                            <div class="product-info">
                                                ...
                                                <div class="text-wrap">
                                                    <strong>제품명</strong>
                                                    <p>제품설명</p>
                                                    <button type="button" class="delete-button"><i
                                                            class="material-icons">&#xe5cd;</i></button>
                                                </div>
                                            </div>
                                        </td>
                        ...
                        <div class="replacement-table-footer">
                            <div class="result-count">
                                ...
                                <strong class="text-primary">58,758</strong>
                                <div class="paging">
                                    <a aref="#" onfocus="this.blur()" class="paging-arrow"><i
        ...
        <div class="added-box margin-top-xxl">
            ...
            <div class="box-body">카테고리 설명이 들어갑니다. 예를 들어 이 제품군에 속하는 제품은 정보를 전송 또는 저장에 적합한 형태로 패키징하거나 암호화하고 특정 형태의 변조 공정을
                통해 통신 경로의 반대쪽에서 역산을 수행하는 데 사용됩니다. 예로는 디지털 데이터로부터 아날로그 비디오 신호를 생성(또는 아날로그 데이터로부터 데이터 비디오 신호를 생성)하는 장치, 원격
                제어 기능을 구현하기 위해 전송 버튼 상태를 암호화하는 장치, 표준 UART를 표준 적외선 트랜시버에 연결할 수 있도록 해 주는 장치가 있습니다.</div>
        </div>
        <!-- !NOTE : 2/3 검색결과 없음 -->
        <div class="search-results">
            <div class="search-results-header">
