...
if( $_POST[name] ) {
	...
	if($_POST[wish_date]){$wish_date	=$tools->filter($_POST[wish_date]);}	// 문의내용
	if($_POST[goal_price]){$goal_price	=$tools->filter($_POST[goal_price]);}	// 정품보유여부
