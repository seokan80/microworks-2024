...
if($lang==2){ // 영문
    ...
    $control_txt_semiconductor_analysis_inquiry = "구매 문의";
...
<article class="modal-fixed-pop-wrapper inquiry-popup" style="display: block">
    <div class="modal-fixed-pop-inner">
        ...
        <div class="modal-inner-content">
            ...
            <!-- 문의 폼 시작 -->
            <form name="controlpopform" id="controlpopform" method="post">
            <input type="hidden" name="phone" value=""/>
                ...
                <article class="bbs-write-tbl-box">
                    ...
                    <tbody>
                        ...
                        <tr>
                        <th scope="row">부품명</th>
                        <td><input type="text" class="write-input width-full" name="part"></td>
                        </tr>
                        <tr>
                        <th scope="row">필요수량</th>
                        <td><input type="text" class="write-input width-full" name="request_quantity"></td>
                        </tr>
                        <tr>
                        <th scope="row">희망납기</th>
                        <td><input type="text" class="write-input width-full" name="wish_date"></td>
                        </tr>
                        <tr>
                        <th scope="row">목표단가</th>
                        <td><input type="text" class="write-input width-full" name="goal_price"></td>
                        </tr>
                        <tr>
                        <th scope="row">내용</th>
                        <td class="size-full">
                ...
                <div class="button-layout bottom-buttons">
                    <button type="button" class="button" onClick="search_sendit();"><strong>작성완료</strong></button>
                    <a href="javascript:;" onclick="$('.modal-fixed-pop-wrapper').hide();" class="button type-secondary"><strong>취소</strong></a>
                </div>
                </section>
            </form>
            <!-- // 문의 폼 끝 -->
...
<script>
    function search_sendit(){
        ...
        if (f.agree1.checked == false) {
            ...
            // AJAX 요청을 보냅니다.
            $.ajax({
                url: "<?=$returnURL?>/index/product/ajax_search_inquery_popup.php",
                type: 'POST',
                data: formData,
                dataType: 'json',
