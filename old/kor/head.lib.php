  ...
  <div class="utilWrap">
    <div class="inner">
      <ul class="util">
        ...
        <li><img src="/kor/images/common/icon_chn.gif" alt="CHINA"> CHINESE</li>
<!--        <li><a href="/chinese"><img src="/kor/images/common/icon_chn.gif" alt="CHINA"> CHINESE</a></li>-->
    ...
    <div class="inner">
      ...
      <div id="topmenu">
        <ul class="navi">
          ...
          <li class="m3"><a href="/bbs/zboard.php?id=eng_memory&kor=kor">Memory Trend</a>
            <div class="submenu">
              <ul>
                <li><a href="/bbs/zboard.php?id=eng_memory&kor=kor">메모리동향</a></li>
                <li><a href="/bbs/zboard.php?id=eng_notice&kor=kor">공지사항</a></li>
              </ul>
            </div>
          </li>
          <li class="m4"><a href="/kor/media/media.php">Media &amp; Download</a>
            <div class="submenu">
              <ul>
                ...
                <li><a href="/kor/Microworks_2018_VER2.0 - Kor.pdf">회사소개자료</a></li>
              </ul>
            </div>
          </li>
  ...
  <div id="content" class="sub">
    <div id="SNB">
  <? 
     if($_GET[kor]=="kor") { include "snb.memory.php";} 
			else {
