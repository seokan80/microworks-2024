...
$month = array('Sij', 'Vel', 'O탑u', 'Tra', 'Svi', 'Lip', 'Srp', 'Kol', 'Ruj', 'Lis', 'Stu', 'Pro');
...
$strAction = 'Akcija';
$strAddDeleteColumn = 'Dodaj/izbri큄i stupac';
$strAddDeleteRow = 'Dodaj/izbri큄i polje za kriterij';
$strAddNewField = 'Dodaj novi stupac';
$strAddSearchConditions = 'Dodaj uvjete pretra탑ivanja (dio "where" upita):';
$strAddToIndex = 'Dodaj klju훾';
...
$strAfterInsertNewInsert = 'Dodaj jo큄 jedan red';
$strAll = 'Sve';
...
$strAPrimaryKey = 'Primarni klju훾 je upravo dodan %s';
$strAscending = 'Rastu훶i';
$strAtBeginningOfTable = 'Na po훾etku tablice';
...
$strBookmarkQuery = 'Ozna훾eni SQL-upit';
$strBookmarkThis = 'Ozna훾i SQL-upit';
$strBookmarkView = 'Vidi samo';
$strBrowse = 'Pregled';
$strBzip = '"bzip-ano"';

$strCantRenameIdxToPrimary = 'Ne mogu promijeniti klju훾 u PRIMARY (primarni) !';
$strCardinality = 'Kardinalnost';
$strChange = 'Promijeni';
$strChangePassword = 'Promijeni 큄ifru';
...
$strCookiesRequired = '<i>Cookies</i> moraju biti omogu훶eni.';
$strCopyTable = 'Kopiram tablicu u (baza<b>.</b>tablica):';
$strCopyTableOK = 'Tablica %s je upravo kopirana u %s.';
$strCreate = 'Napravi';
$strCreateIndex = 'Napravi klju훾 sa&nbsp;%s&nbsp;stupcem(aca)';
...
$strDoYouReally = 'Da li stvarno 탑elite ';
$strDrop = 'Izbri큄i';
...
$strIndex = 'Klju훾';
$strIndexes = 'Klju훾evi';
$strIndexHasBeenDropped = 'Klju훾 %s je izbrisan';
$strIndexName = 'Ime klju훾a :';
$strIndexType = 'Vrsta klju훾a :';
...
$strLinesTerminatedBy = 'Linije zavr큄avaju na';
$strLinksTo = 'Links to';
...
$strModify = 'Promijeni';
$strModifyIndexTopic = 'Promijeni klju훾';
...
$strMySQLShowStatus = 'Prika탑i MySQL runtime informacije';
...
$strNoDropDatabases = '"DROP DATABASE" naredba je onemogu훶ena.';
$strNoFrames = 'phpMyAdmin preferira preglednike koji podr탑avaju frame-ove.';
$strNoIndex = 'Klju훾 nije definiran!';
$strNoIndexPartsDefined = 'Dijelovi klju훾a nisu definirani!';
$strNoModification = 'Nema nikakvih promjena';
$strNone = 'Ni큄ta';
$strNoPassword = 'Nema lozinke';
$strNoPrivileges = 'Nema privilegija';
$strNoRights = 'Nemate dovoljno prava za ovo podru훾je!';
$strNoTablesFound = 'Tablica nije prona휃ena u bazi.';
$strNotNumber = 'To nije broj!';
$strNoUsersFound = 'Korisnik(ci) nije prona휃en.';
$strNull = 'Null';
...
$strPmaUriError = '<tt>$cfg[\'PmaAbsoluteUri\']</tt> dio mora biti namje큄ten u konfiguracijskoj datoteci (config.inc.php)!';
$strPos1 = 'Po훾etak';
$strPrevious = 'Prethodna';
$strPrimary = 'Primarni';
$strPrimaryKeyHasBeenDropped = 'Primarni klju훾 je izbrisan';
$strPrimaryKeyName = 'Ime primarnog klju훾a mora biti... PRIMARY!';
$strPrimaryKeyWarning = '("PRIMARY" <b>mora</b> biti ime i <b>samo</b> ime primarnog klju훾a!)';
$strPrintView = 'Sa탑etak';
...
$strSetEnumVal = 'Ako je polje "enum" ili "set", unesite vrijednosti u formatu: \'a\',\'b\',\'c\'...<br />Ako vam zatreba <i>backslash</i> ("\") ili jednostruki navodnik ("\'") navedite ih koriste훶i <i>backslash</i> (npr. \'\\\\xyz\' ili \'a\\\'b\').';
$strShow = 'Prika탑i';
...
$strShowThisQuery = ' Prika탑i ovaj upit ponovo ';
...
$strSubmit = 'Pokreni';
$strSuccess = 'Va큄 SQL upit je uspje큄no izvr큄en';
$strSum = 'Ukupno';
...
$strTableHasBeenEmptied = 'Tablica %s je ispra탑njena';
$strTableHasBeenFlushed = 'Tablica %s je osvje탑ena';
$strTableMaintenance = 'Radnje na tablici';
$strTables = '%s tablica/e';
$strTableStructure = 'Struktura tablice';
$strTableType = 'Vrsta tablice';
$strTextAreaLength = ' Zbog veli훾ine ovog polja,<br /> polje mo탑da ne훶ete mo훶i mijenjati ';
$strTotal = 'ukupno';
$strType = 'Vrsta';

$strUncheckAll = 'Makni oznake';
$strUnique = 'Jedinstveni klju훾';
...
$strValue = 'Vrijednost';
$strViewDump = 'Prika탑i dump (shemu) tablice';
$strViewDumpDB = 'Prika탑i dump (shemu) baze';

$strWelcome = 'Dobrodo큄li u %s';
