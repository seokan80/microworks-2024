...
$strFields = 'Campi';
$strFieldsEmpty = ' Il contatore dei campi 챔 vuoto! ';
...
$strIndexWarningMultiple = 'Pi첫 di una chiave %s 챔 stata creata per la colonna `%s`';
...
$strMIME_transformation_options_note = 'Prego, immettere i valori per le opzioni di trasformazioneutilizzando questo formato: \'a\',\'b\',\'c\'...<br />Se c\'챔 la necessit횪 di immettere un backslash ("\") o un apostrofo ("\'") tra questi valori, essi vanno backslashati (per es. \'\\\\xyz\' or \'a\\\'b\').';
...
$strPrivDescMaxQuestions = 'Limita il numero di queries che un utente pu챵 mandare al server in un\'ora.';
...
$strSQLExportCompatibility = 'Compatibilit횪 dell\'esportazione SQL';
...
$strThisNotDirectory = 'Questa non 챔 una directory';
$strThreads = 'Processi';
...
$strTransformation_text_plain__dateformat = 'Prende un campo TIME, TIMESTAMP o DATETIME e lo formatta utilizzando il formato data locale. La prima opzione 챔 il time offset (in ore) il quale sar횪 aggiunto al timestamp (Predefinito: 0). La seconda opzione 챔 un formato data in linea con i parametri disponibili per la funzione strftime() del PHP.';
