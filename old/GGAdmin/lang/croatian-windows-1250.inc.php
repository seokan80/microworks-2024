...
$month = array('Sij', 'Vel', 'O엞', 'Tra', 'Svi', 'Lip', 'Srp', 'Kol', 'Ruj', 'Lis', 'Stu', 'Pro');
...
$strAction = 'Akcija';
$strAddDeleteColumn = 'Dodaj/izbri쉏 stupac';
$strAddDeleteRow = 'Dodaj/izbri쉏 polje za kriterij';
$strAddNewField = 'Dodaj novi stupac';
$strAddSearchConditions = 'Dodaj uvjete pretra엍vanja (dio "where" upita):';
...
$strChange = 'Promijeni';
$strChangePassword = 'Promijeni 쉏fru';
...
$strDoYouReally = 'Da li stvarno 엁lite ';
$strDrop = 'Izbri쉏';
...
$strLinesTerminatedBy = 'Linije zavr쉆vaju na';
$strLinksTo = 'Links to';
...
$strMySQLShowStatus = 'Prika엍 MySQL runtime informacije';
$strMySQLShowVars = 'Prika엍 MySQL sistemske varijable';
...
$strNoFrames = 'phpMyAdmin preferira preglednike koji podr얷vaju frame-ove.';
...
$strPmaUriError = '<tt>$cfg[\'PmaAbsoluteUri\']</tt> dio mora biti namje쉞en u konfiguracijskoj datoteci (config.inc.php)!';
$strPos1 = 'Po?tak';
...
$strShowTables = 'Prika엍 tablice';
$strShowThisQuery = ' Prika엍 ovaj upit ponovo ';
...
$strSubmit = 'Pokreni';
$strSuccess = 'Va?SQL upit je uspje쉗o izvr쉋n';
$strSum = 'Ukupno';
...
$strTableHasBeenEmptied = 'Tablica %s je ispra엖jena';
$strTableHasBeenFlushed = 'Tablica %s je osvje엁na';
$strTableMaintenance = 'Radnje na tablici';
$strTables = '%s tablica/e';
$strTableStructure = 'Struktura tablice';
$strTableType = 'Vrsta tablice';
$strTextAreaLength = ' Zbog veli?ne ovog polja,<br /> polje mo엀a ne?te mo? mijenjati ';
$strTotal = 'ukupno';
$strType = 'Vrsta';
...
$strValue = 'Vrijednost';
$strViewDump = 'Prika엍 dump (shemu) tablice';
$strViewDumpDB = 'Prika엍 dump (shemu) baze';

$strWelcome = 'Dobrodo쉕i u %s';
