...
$month = array('Sij', 'Vel', 'O푫', 'Tra', 'Svi', 'Lip', 'Srp', 'Kol', 'Ruj', 'Lis', 'Stu', 'Pro');
...
$strAction = 'Akcija';
$strAddDeleteColumn = 'Dodaj/izbri퉕 stupac';
$strAddDeleteRow = 'Dodaj/izbri퉕 polje za kriterij';
$strAddNewField = 'Dodaj novi stupac';
$strAddSearchConditions = 'Dodaj uvjete pretra푝vanja (dio "where" upita):';
...
$strAscending = 'Rastu?';
$strAtBeginningOfTable = 'Na po?tku tablice';
...
$strBookmarkQuery = 'Ozna?ni SQL-upit';
$strBookmarkThis = 'Ozna? SQL-upit';
...
$strChange = 'Promijeni';
$strChangePassword = 'Promijeni 퉕fru';
...
$strCookiesRequired = '<i>Cookies</i> moraju biti omogu?ni.';
...
$strDoYouReally = 'Da li stvarno 푘lite ';
$strDrop = 'Izbri퉕';
...
$strError = 'Gre퉗a';
$strExtendedInserts = 'Pro퉕reni INSERT';
$strExtra = 'Dodatno';
...
$strLengthSet = 'Du푝na/Vrijednost*';
$strLimitNumRows = 'Broj redaka po stranici';
$strLinesTerminatedBy = 'Linije zavr퉍vaju na';
$strLinksTo = 'Links to';
...
$strMySQLShowProcess = 'Prika푝 listu procesa';
$strMySQLShowStatus = 'Prika푝 MySQL runtime informacije';
$strMySQLShowVars = 'Prika푝 MySQL sistemske varijable';

$strName = 'Ime';
$strNext = 'Sljede?';
$strNo = 'Ne';
$strNoDatabases = 'Baza ne postoji';
$strNoDropDatabases = '"DROP DATABASE" naredba je onemogu?na.';
$strNoFrames = 'phpMyAdmin preferira preglednike koji podr푔vaju frame-ove.';
$strNoIndex = 'Klju?nije definiran!';
$strNoIndexPartsDefined = 'Dijelovi klju? nisu definirani!';
$strNoModification = 'Nema nikakvih promjena';
$strNone = 'Ni퉡a';
$strNoPassword = 'Nema lozinke';
$strNoPrivileges = 'Nema privilegija';
$strNoRights = 'Nemate dovoljno prava za ovo podru?e!';
$strNoTablesFound = 'Tablica nije prona?na u bazi.';
$strNotNumber = 'To nije broj!';
$strNoUsersFound = 'Korisnik(ci) nije prona?n.';
$strNull = 'Null';
...
$strPmaUriError = '<tt>$cfg[\'PmaAbsoluteUri\']</tt> dio mora biti namje퉡en u konfiguracijskoj datoteci (config.inc.php)!';
$strPos1 = 'Po?tak';
$strPrevious = 'Prethodna';
$strPrimary = 'Primarni';
$strPrimaryKeyHasBeenDropped = 'Primarni klju?je izbrisan';
$strPrimaryKeyName = 'Ime primarnog klju? mora biti... PRIMARY!';
$strPrimaryKeyWarning = '("PRIMARY" <b>mora</b> biti ime i <b>samo</b> ime primarnog klju?!)';
$strPrintView = 'Sa푘tak';
...
$strRowLength = 'Du푝na retka';
$strRows = 'Redaka';
$strRowsFrom = ' redaka po?v퉕 od retka';
$strRowSize = ' Veli?na retka ';
$strRowsModeHorizontal = 'horizontalnom';
$strRowsModeOptions = 'u %s na?nu i ispi퉕 zaglavlje poslije svakog %s retka';
$strRowsModeVertical = 'vertikalnom';
$strRowsStatistic = 'Statistika redaka';
$strRunning = 'pokrenuto na %s';
$strRunQuery = 'Izvr퉕 SQL upit';
$strRunSQLQuery = 'Izvr퉕 SQL upit(e) na bazi ';

$strSave = 'Spremi';
$strSelectADb = 'Izaberite bazu';
$strSelectAll = 'Ozna? sve';
...
$strSetEnumVal = 'Ako je polje "enum" ili "set", unesite vrijednosti u formatu: \'a\',\'b\',\'c\'...<br />Ako vam zatreba <i>backslash</i> ("\") ili jednostruki navodnik ("\'") navedite ih koriste? <i>backslash</i> (npr. \'\\\\xyz\' ili \'a\\\'b\').';
$strShow = 'Prika푝';
$strShowAll = 'Prika푝 sve';
$strShowingRecords = 'Prikaz redaka';
$strShowPHPInfo = 'Prika푝 informacije o PHP-u';
$strShowTables = 'Prika푝 tablice';
$strShowThisQuery = ' Prika푝 ovaj upit ponovo ';
...
$strSubmit = 'Pokreni';
$strSuccess = 'Va?SQL upit je uspje퉚o izvr퉑n';
$strSum = 'Ukupno';
...
$strTableHasBeenEmptied = 'Tablica %s je ispra푣jena';
$strTableHasBeenFlushed = 'Tablica %s je osvje푘na';
$strTableMaintenance = 'Radnje na tablici';
$strTables = '%s tablica/e';
$strTableStructure = 'Struktura tablice';
$strTableType = 'Vrsta tablice';
$strTextAreaLength = ' Zbog veli?ne ovog polja,<br /> polje mo푗a ne?te mo? mijenjati ';
$strTotal = 'ukupno';
$strType = 'Vrsta';
...
$strValue = 'Vrijednost';
$strViewDump = 'Prika푝 dump (shemu) tablice';
$strViewDumpDB = 'Prika푝 dump (shemu) baze';

$strWelcome = 'Dobrodo퉘i u %s';
$strWithChecked = 'Ozna?no:';
$strWrongUser = 'Pogre퉚o korisni?o ime/lozinka. Pristup odbijen.';
