...
<head>
	...
	<? if ($_GET[id]=="eng_memory" || $_GET[id]=="eng_notice"){ ?>
...
<body topmargin='0'  leftmargin='0' marginwidth='0' marginheight='0' <?=$body?><?
			...
			?>>
			<?
//			$_kor_path = "/iweb/mworksk/wwwhome/kor/";
//			include "head.lib.php";
			if($_GET[kor]=="kor") { include $_SERVER['DOCUMENT_ROOT']."/kor/head.lib.php";} 
			else {
...
<body topmargin='0'  leftmargin='0' marginwidth='0' marginheight='0' <?=$body?>>
	...
	function foot() {
		...
		if($setup[skinname]) {
			...
			if($_GET[kor]=="kor") { include $_SERVER['DOCUMENT_ROOT']."/kor/foot.lib.php";} 
			else {
