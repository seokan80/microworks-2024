...
<table class='type01' border=0 cellspacing=0 cellpadding=0 width=<?=$width?>>
<tr class=title>
	<th class=title_han colspan=2 align=left style=word-break:break-all;padding-left:10px;>
		<b><?=$subject?></b>
	</th>
</tr>
<tr class=list1>
