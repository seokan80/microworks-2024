...
if($search_order){
    ...
    } else if($search_item == 'part_name'){
        $query.=" and part_name like '%$search_order%'";
    } else if($search_item == 'request_quantity'){
        $query.=" and request_quantity like '%$search_order%'";
    } else if($search_item == 'content'){
        $query.=" and content like '%$search_order%'";
    } else{
        $query.=" and (name like '%$search_order%' or phone like '%$search_order%' or part_name like '%$search_order%' or request_quantity like '%$search_order%' or content like '%$search_order%')";
    }
}
                ...
                <div class="form-group">
                    <div class="input-group-btn">
                        <select name="search_item" class="form-control input-sm" >
                            ...
                            <option value="part_name" <?if($search_item=="part_name"){?>selected<?}?>>부품명</option>
                            <option value="request_quantity" <?if($search_item=="request_quantity"){?>selected<?}?>>필요수량</option>
