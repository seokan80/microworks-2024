...
?>
    ...
    <tr>
      ...
      <td>
        ...
        <label class="radio-inline"><input type="radio" name="period" value="N" onClick="disabledDate();">미사용</label>
      </td>
    </tr>
    <tr>
      <th>게시기간</th>
...
$(document).ready(function () {
    ...
    document.tx_editor_form.period_start_date.value = '<?=$bbs_stat->period_start_date?>';
    document.tx_editor_form.period_end_date.value = '<?=$bbs_stat->period_end_date?>';
});
<?}?>
